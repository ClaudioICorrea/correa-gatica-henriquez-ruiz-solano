'''
Convergence test for a double mixed scheme for the stationary 
Poisson-Nernst-Planck / Stokes coupled equations
Domain Omega is (0,1)^2 with boundary Gamma
...
# ISSUE!! with other parameters the convergence is compromised. Check! 
...
print("r = ",r,", s = ",s,", rho = ",rho,", varrho= ",varrho)
...
for nk in range(nkmax):
    ...
    rho = Constant(rho); varrho = Constant(varrho)
    r   = Constant(r); s   = Constant(s)
